    ...
    fetch('http://ws.audioscrobbler.com/2.0/?method=tag.getTopTags&api_key=2c08f218f45c6f367a0f4d2b350bbffc')
        ...
        .then(xml => {
            ...
            const promises = tags.map(async (genre) => {
                const xml = await ((await fetch('http://ws.audioscrobbler.com/2.0/?method=tag.getinfo&tag=' + urlencode(genre.toString()) + '&api_key=2c08f218f45c6f367a0f4d2b350bbffc')).text());
